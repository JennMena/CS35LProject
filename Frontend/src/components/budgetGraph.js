...
const BudgetGraph = () => {
  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', marginTop: '-30px', gap: '20px' }}> {/* Adjust the gap here */}
        <div style={{ flex: 1.2 }}>
          <h4 style={{ marginBottom: '-20px' }}>Budget, Spent, and Income</h4> {/* Adjust margin-bottom here */}
          <PieChart
        ...
        <div style={{ flex: 1 }}>
          <h4 style={{ marginBottom: '-20px' }}>Remaining and Spent</h4> {/* Adjust margin-bottom here */}
          <PieChart
